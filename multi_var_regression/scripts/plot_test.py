...
scatplot_facet(x='year_month', y=('rate_'+str(per_num)), data=dat, facet_col='state_name',
                 hue='month', title_main='Death rates by state',
...
linplot_facet(x='year_month', y=('rate_'+str(per_num)), data=dat,
                 facet_col='state_name', hue='month', title_main='Death rates by state',
