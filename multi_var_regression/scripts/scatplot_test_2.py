...
from functions.plot.scatplot_facet import scatplot_facet_1

dat = pd.read_csv(TEMP_TEST_1, index_col=0, nrows=2000)
...
# plot data factored
scatplot_facet_1(x='year', y='rate_100000', facet_col='state_name',
