...
start = time.perf_counter()
regr_3 = log_regr(os.path.join(str(TEMP_TEST_B), str('1982_2013'), 'mort_against_climate_complete.csv'),
...
start = time.perf_counter()
regr_4 = log_regr(os.path.join(str(TEMP_TEST_B), str('1982_2013'), 'mort_against_climate_complete.csv'),
